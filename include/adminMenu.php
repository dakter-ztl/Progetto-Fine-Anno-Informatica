...
if (!isset($_SESSION['ruoloUtente']) || strtolower($_SESSION['ruolo']) !== 'adminUtente') {
        ...
        <div class="col-md-5 mb-4">
            <div class="card shadow-sm h-100 border-0 hover-effect">
                <div class="card-body text-center p-5">
                    ...
                    <a href="inserisciMateria.php" class="btn btn-primary btn-lg mt-3 w-100">
        ...
        <div class="col-md-5 mb-4">
            <div class="card shadow-sm h-100 border-0 hover-effect">
                <div class="card-body text-center p-5">
                    ...
                    <a href="inserisciPercorso.php" class="btn btn-success btn-lg mt-3 w-100">
