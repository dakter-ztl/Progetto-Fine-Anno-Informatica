...
<nav class="navbar navbar-expand-sm navbar-dark bg-dark mb-4">
  <div class="container-fluid">
    <a class="navbar-brand" href="<?php echo $GLOBALS['menuPathPrefix']; ?>home.php">Next Step </a>
    ...
    <div class="collapse navbar-collapse" id="mynavbar">
      <ul class="navbar-nav me-auto">
        <li class="nav-item">
          <a class="nav-link" href="<?php echo $GLOBALS['menuPathPrefix']; ?>home.php">Simulatore</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="<?php echo $GLOBALS['menuPathPrefix']; ?>bacheca.php">Bacheca</a>
        </li>
